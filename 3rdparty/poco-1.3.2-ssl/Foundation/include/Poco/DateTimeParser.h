...
public:
	...
	static DateTime parseFromStream(const std::string& fmt, std::istream & is);
	static DateTime parseFromStream(const std::string& fmt, std::istream & is, int & timeZoneDifferential);
	static void parseFromStream(const std::string& fmt, std::istream & is, DateTime & dateTime);	
	static void parseFromStream(const std::string& fmt, std::istream & is, DateTime & dateTime, int & timeZoneDifferential);	
	
	static bool tryParseFromStream(const std::string& fmt, std::istream & is, DateTime & dateTime);
	static bool tryParseFromStream(const std::string& fmt, std::istream & is, DateTime & dateTime, int & timeZoneDifferential);
};
