#ifndef GUARD_LIBVW_PACKETS_SERIALIZATION_H_INCLUDED
#define GUARD_LIBVW_PACKETS_SERIALIZATION_H_INCLUDED
...
namespace vw
{
	namespace packets
	{
		...
		struct Deserializer : boost::noncopyable
		{
			...
			{
				libvw_ensure(m_buffer.size() >= m_offset);
				libvw_ensure(m_buffer.size() - m_offset >= length);
...
#define LIBVW_PACKETS_IMPLEMENT_GENERIC_SERIALIZER_IMPL(STYPE,TO_NET,FROM_NET) \
...
#define LIBVW_PACKETS_IMPLEMENT_GENERIC_SERIALIZER(STYPE) \
		LIBVW_PACKETS_IMPLEMENT_GENERIC_SERIALIZER_IMPL(STYPE,NoConvert,NoConvert)
#define LIBVW_PACKETS_IMPLEMENT_GENERIC_SERIALIZER_BYTEORDER(STYPE) \
		LIBVW_PACKETS_IMPLEMENT_GENERIC_SERIALIZER_IMPL(STYPE,Poco::ByteOrder::toNetwork,Poco::ByteOrder::fromNetwork)

		LIBVW_PACKETS_IMPLEMENT_GENERIC_SERIALIZER(Int8)
		LIBVW_PACKETS_IMPLEMENT_GENERIC_SERIALIZER_BYTEORDER(Int16)
		LIBVW_PACKETS_IMPLEMENT_GENERIC_SERIALIZER_BYTEORDER(Int32)
		LIBVW_PACKETS_IMPLEMENT_GENERIC_SERIALIZER_BYTEORDER(Int64)
		LIBVW_PACKETS_IMPLEMENT_GENERIC_SERIALIZER(UInt8)
		LIBVW_PACKETS_IMPLEMENT_GENERIC_SERIALIZER_BYTEORDER(UInt16)
		LIBVW_PACKETS_IMPLEMENT_GENERIC_SERIALIZER_BYTEORDER(UInt32)
		LIBVW_PACKETS_IMPLEMENT_GENERIC_SERIALIZER_BYTEORDER(UInt64)
		LIBVW_PACKETS_IMPLEMENT_GENERIC_SERIALIZER_IMPL(Real32,RealToNetwork,RealFromNetwork)
		LIBVW_PACKETS_IMPLEMENT_GENERIC_SERIALIZER_IMPL(Real64,RealToNetwork,RealFromNetwork)
...
#endif //GUARD_LIBVW_PACKETS_SERIALIZATION_H_INCLUDED
